  ...
  <div id="myPrint" class="dashboard-container">
    <div class="app-container">
      <el-card>
        ...
        <!-- 利用v-print='printObj' 完成页面的打印 -->
        <el-row type="flex" justify="end">
          <el-bubtton v-print="printObj" size="mini" type="primaty" color="blue">打印</el-bubtton>
        </el-row>
        <div v-if="type === 'personal'">
          <h2 class="centInfo">员工信息表</h2>
          <table cellspacing="0" border="1" width="100%" class="tableList">
            <tr class="title">
