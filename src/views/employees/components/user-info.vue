  ...
  methods: {
    async getUserDetailById() {
      ...
      if (this.userInfo.staffPhoto && this.userInfo.staffPhoto.trim()) {
        ...
        // console.log(this.$refs.staffPhoto.fileList)
      }
    },
    ...
    async savePersonal() {
      ...
      this.$message.success('保存成功')
      this.getPersonalDetail() // 重新获取最新数据 渲染界面
    }
  }
}
</script>
