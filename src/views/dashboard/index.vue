    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <!-- 处理默认图片 -->
            <img v-imagerror="dafaultImg" :src="staffPhoto">
          </div>
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ name }}，祝你开心每一天！</p>
            <p class="lastChild">
              <!-- {{ name }} | {{ $store.state.user.userInfo.company }}-{{ $store.state.user.userInfo.departmentName }} -->
              <!-- 辅助函数 -->
      ...
      <el-col :span="11">
        <el-card class="box-card">
          ...
          <div class="sideNav">
            ...
            <el-button class="sideBtn" @click="$router()">请假调休</el-button>
...
export default {
  ...
  data() {
    return {
      dafaultImg: require('@/assets/common/head.jpg'),
      showDialog: false,
      ruleForm: {
        exceptTime: '',
        reason: '',
